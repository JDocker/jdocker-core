...
public final class ServiceContextManager {
    ...
    /** The logger used. */
    private static final Logger LOG = Logger.getLogger(org.apache.tamaya.spi.ServiceContextManager.class.getName());
...
//        }
    ...
    public static ServiceContext set(ServiceContext serviceContextProvider) {
        ...
        synchronized (org.apache.tamaya.spi.ServiceContextManager.class) {
