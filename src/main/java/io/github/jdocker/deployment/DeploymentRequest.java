...
import io.github.jdocker.DockerContainer;
import io.github.jdocker.NetworkMode;
import io.github.jdocker.RestartPolicy;

import java.util.*;

/**
 * Request encapsulating {@code docker create ...} to deploy a container.
 */
...
//    -a, --attach=[]                 Attach to STDIN, STDOUT or STDERR
    ...
    public DeploymentRequest addCustomHostToIPMapping(String... customHostToIPMappings) {
    ...
    public DeploymentRequest setBlkIOWeight(int blkIOWeight) {
        this.blkIOWeight = blkIOWeight;
        return this;
    }

    public DeploymentRequest setCpuShares(int cpuShares) {
        this.cpuShares = cpuShares;
        return this;
    }

    public DeploymentRequest addCapabilities(String... capabilities) {
    ...
    public DeploymentRequest removeCapabilities(String... capabilities) {
        for(String cap:capabilities){
    ...
    public DeploymentRequest setParentCgroup(String parentCgroup) {
        this.parentCgroup = parentCgroup;
        return this;
    }

    public DeploymentRequest setCidfile(String cidfile) {
        this.cidfile = cidfile;
        return this;
    }

    public DeploymentRequest setCpuPeriod(int cpuPeriod) {
        this.cpuPeriod = cpuPeriod;
        return this;
    }

    public DeploymentRequest setCpuQuoty(int cpuQuoty) {
        this.cpuQuoty = cpuQuoty;
        return this;
    }

    public DeploymentRequest setNumCPUs(int numCPUs) {
        this.numCPUs = numCPUs;
        return this;
    }

    public DeploymentRequest setMemory(String memory) {
        this.memory = memory;
        return this;
    }

    public DeploymentRequest addHostDevices(String... hostDevices) {
    ...
    public DeploymentRequest setDisabledContentTrust(boolean disabledContentTrust) {
        this.disabledContentTrust = disabledContentTrust;
        return this;
    }

    public DeploymentRequest addDnsServers(String... dnsServers) {
    ...
    public DeploymentRequest addDnsSearchDomains(String... dnsSearch) {
    ...
    public DeploymentRequest setEnvironment(Map<String, String> environment) {
        this.environment = environment;
        return this;
    }

    public DeploymentRequest setEntryPoint(String entryPoint) {
        this.entryPoint = entryPoint;
        return this;
    }

    public DeploymentRequest setEnvironmentFiles(List<String> environmentFiles) {
        this.environmentFiles = environmentFiles;
        return this;
    }

    public DeploymentRequest setExposedPorts(Set<String> exposedPorts) {
        this.exposedPorts = exposedPorts;
        return this;
    }

    public DeploymentRequest setGroups(Set<String> groups) {
        this.groups = groups;
        return this;
    }

    public DeploymentRequest setHost(String host) {
        this.host = host;
        return this;
    }

    public DeploymentRequest setIpcNS(String ipcNS) {
        this.ipcNS = ipcNS;
        return this;
    }

    public DeploymentRequest setLabel(String key, String value) {
        this.labels.put(key, value);
        return this;
    }

    public DeploymentRequest setLabelField(String... labelFields) {
    ...
    public DeploymentRequest setLinks(Set<String> links) {
        this.links = links;
        return this;
    }

    public DeploymentRequest setLoggingDriver(String loggingDriver) {
        this.loggingDriver = loggingDriver;
        return this;
    }

    public DeploymentRequest setLxcConfig(String key, String value) {
        this.lxcConfig.put(key, value);
        return this;
    }

    public DeploymentRequest setMemoryLimit(String memoryLimit) {
        this.memoryLimit = memoryLimit;
        return this;
    }

    public DeploymentRequest setMacAddress(String macAddress) {
        this.macAddress = macAddress;
        return this;
    }

    public DeploymentRequest setTotalMemory(int totalMemory) {
        this.totalMemory = totalMemory;
        return this;
    }

    public DeploymentRequest setMemorySwapiness(int memorySwapiness) {
        this.memorySwapiness = memorySwapiness;
        return this;
    }

    public DeploymentRequest setName(String name) {
        this.name = name;
        return this;
    }

    public DeploymentRequest setNetworkMode(NetworkMode networkMode) {
        this.networkMode = networkMode;
        return this;
    }

    public DeploymentRequest setDisableDOMKill(boolean disableDOMKill) {
        this.disableDOMKill = disableDOMKill;
        return this;
    }

    public DeploymentRequest setPublishedRandomPorts(boolean publishedRandomPorts) {
        this.publishedRandomPorts = publishedRandomPorts;
        return this;
    }

    public DeploymentRequest addPorts(String... ports) {
        for(String p:ports){
            this.ports.add(p);
        }
        return this;
    ...
    public DeploymentRequest setPidNamespace(String pidNamespace) {
        this.pidNamespace = pidNamespace;
        return this;
    }

    public DeploymentRequest setPrivileged(boolean privileged) {
        this.privileged = privileged;
        return this;
    }

    public DeploymentRequest setMountReadOnlyFS(boolean mountReadOnlyFS) {
        this.mountReadOnlyFS = mountReadOnlyFS;
        return this;
    }

    public DeploymentRequest setRestartPolicy(RestartPolicy restartPolicy) {
        this.restartPolicy = restartPolicy;
        return this;
    }

    public DeploymentRequest setSecurityOption(String key, String securityOptions) {
        this.securityOptions.put(key, securityOptions);
        return this;
    }

    public DeploymentRequest setUser(String user) {
        this.user = user;
        return this;
    }

    public DeploymentRequest setUlimitOptions(Set<String> ulimitOptions) {
        this.ulimitOptions = ulimitOptions;
        return this;
    }

    public DeploymentRequest setUtsNamespace(String utsNamespace) {
        this.utsNamespace = utsNamespace;
        return this;
    }

    public DeploymentRequest setVolumes(Map<String, String> volumes) {
        this.volumes = volumes;
        return this;
    }

    public DeploymentRequest setVolumeDriver(String volumeDriver) {
        this.volumeDriver = volumeDriver;
        return this;
    }

    public DeploymentRequest setVolumesFrom(Set<String> volumesFrom) {
