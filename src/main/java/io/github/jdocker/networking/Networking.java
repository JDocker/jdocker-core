...
public class Networking {
     ...
     */
    public static void installNetworking(Machine machine){
     ...
     */
    public static void stopNetworking(Machine machine){
     ...
     * @param machine the machine, not null.
     */
    public static void startNetworking(Machine machine){
